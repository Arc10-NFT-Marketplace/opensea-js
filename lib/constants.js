...
exports.OPENSEA_FEE_RECIPIENT = process.env.REACT_APP_CUSTOM_FEE_RECIPIENT || process.env.CUSTOM_FEE_RECIPIENT || '0x5b3256965e7c3cf26e11fcaf296dfc8807c01073';
...
exports.CUSTOM_PROVIDER_URL = process.env.REACT_APP_CUSTOM_PROVIDER_URL || process.env.CUSTOM_PROVIDER_URL || 'http://localhost:8545';
...
exports.API_BASE_CUSTOM = process.env.REACT_APP_API_BASE_CUSTOM || process.env.API_BASE_CUSTOM || 'http://localhost:3000';
exports.SITE_HOST_MAINNET = 'https://opensea.io';
exports.SITE_HOST_RINKEBY = 'https://rinkeby.opensea.io';
exports.SITE_HOST_CUSTOM = process.env.REACT_APP_SITE_HOST_CUSTOM || process.env.SITE_HOST_CUSTOM || 'http://localhost:3000';
exports.ORDERBOOK_PATH = process.env.REACT_APP_ORDERBOOK_PATH || process.env.ORDERBOOK_PATH || "/wyvern/v" + exports.ORDERBOOK_VERSION;
exports.API_PATH = process.env.REACT_APP_API_PATH || process.env.API_PATH || "/api/v" + exports.ORDERBOOK_VERSION;

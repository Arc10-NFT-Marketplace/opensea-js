...
var OpenSeaPort = /** @class */ (function () {
    ...
    function OpenSeaPort(provider, apiConfig, logger) {
        ...
        var readonlyProvider;
        switch (this._networkName) {
            case types_1.Network.Main: {
                readonlyProvider = new Web3.providers.HttpProvider(constants_1.MAINNET_PROVIDER_URL);
                break;
            }
            case types_1.Network.Rinkeby: {
                readonlyProvider = new Web3.providers.HttpProvider(constants_1.RINKEBY_PROVIDER_URL);
                break;
            }
            case types_1.Network.Custom: {
                readonlyProvider = new Web3.providers.HttpProvider(constants_1.CUSTOM_PROVIDER_URL);
            }
        }
        // Web3 Config
        ...
        if (this._networkName != types_1.Network.Custom) {
    ...
    OpenSeaPort.prototype._makeBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var schema, quantityBN, wyAsset, openSeaAsset, taker, _d, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, _e, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _f, target, calldata, replacementPattern, _g, basePrice, extra, paymentToken, times, _h, staticTarget, staticExtradata, exchange;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    ...
                    case 4:
                        ...
                        exchange = window._env_.REACT_APP_WYVERN_EXCHANGE ||
    ...
    OpenSeaPort.prototype._makeBundleBuyOrder = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var quantityBNs, bundle, orderedSchemas, taker, asset, _d, _e, totalBuyerFeeBasisPoints, totalSellerFeeBasisPoints, _f, makerRelayerFee, takerRelayerFee, makerProtocolFee, takerProtocolFee, makerReferrerFee, feeRecipient, feeMethod, _g, calldata, replacementPattern, _h, basePrice, extra, paymentToken, times, exchange, target;
            var _this = this;
            return __generator(this, function (_j) {
                switch (_j.label) {
                    case 0:
                    ...
                    case 5:
                        ...
                        exchange = window._env_.REACT_APP_WYVERN_EXCHANGE ||
                            ...
                            process.env.REACT_APP_WYVERN_EXCHANGE ||
                            wyvern_js_1.WyvernProtocol.getExchangeContractAddress(this._networkName);
                        target = window._env_.REACT_APP_WYVERN_ATOMICIZER ||
                            process.env.WYVERN_ATOMICIZER ||
                            process.env.REACT_APP_WYVERN_ATOMICIZER ||
                            wyvern_js_1.WyvernProtocol.getAtomicizerContractAddress(this._networkName);
                        return [2 /*return*/, {
                                exchange: exchange,
                                maker: accountAddress,
                                taker: taker,
    ...
    OpenSeaPort.prototype._makeMatchingOrder = function (_a) {
        ...
        var computeOrderParams = function () {
            if ('asset' in order.metadata) {
                ...
                var atomicizer = window._env_.REACT_APP_WYVERN_ATOMICIZER ||
                    process.env.WYVERN_ATOMICIZER ||
                    process.env.REACT_APP_WYVERN_ATOMICIZER ||
                    wyvern_js_1.WyvernProtocol.getAtomicizerContractAddress(_this._networkName);
                return {
                    target: atomicizer,

...
var OpenSeaAPI = /** @class */ (function () {
    ...
    function OpenSeaAPI(config, logger) {
        ...
        switch (config.networkName) {
            ...
            case types_1.Network.Custom:
                this.apiBaseUrl = config.apiBaseUrl || constants_1.API_BASE_CUSTOM;
                this.hostUrl = constants_1.SITE_HOST_CUSTOM;
                break;
    ...
    OpenSeaAPI.prototype._fetch = function (apiPath, opts) {
        if (opts === void 0) { opts = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var apiBase, apiKey, authToken, finalUrl, finalOpts;
            var _this = this;
            return __generator(this, function (_a) {
                ...
                finalOpts = __assign({}, opts, { headers: __assign({}, (apiKey ? { 'X-API-KEY': apiKey } : {}), (authToken ? { 'Authorization': "Bearer " + authToken } : {}), (opts.headers || {})) });

...
export const OPENSEA_FEE_RECIPIENT = window._env_.REACT_APP_CUSTOM_FEE_RECIPIENT || process.env.REACT_APP_CUSTOM_FEE_RECIPIENT || process.env.CUSTOM_FEE_RECIPIENT || '0x5b3256965e7c3cf26e11fcaf296dfc8807c01073'
...
export const CUSTOM_PROVIDER_URL = window._env_.REACT_APP_CUSTOM_PROVIDER_URL || process.env.REACT_APP_CUSTOM_PROVIDER_URL || process.env.CUSTOM_PROVIDER_URL || 'http://localhost:8545'
...
export const DEFAULT_BUYER_FEE_BASIS_POINTS = 150
export const DEFAULT_SELLER_FEE_BASIS_POINTS = 350
...
export const API_BASE_CUSTOM = window._env_.REACT_APP_API_BASE_CUSTOM || process.env.REACT_APP_API_BASE_CUSTOM || process.env.API_BASE_CUSTOM || 'http://localhost:3000'
export const SITE_HOST_MAINNET = 'https://opensea.io'
export const SITE_HOST_RINKEBY = 'https://rinkeby.opensea.io'
export const SITE_HOST_CUSTOM = window._env_.REACT_APP_SITE_HOST_CUSTOM || process.env.REACT_APP_SITE_HOST_CUSTOM || process.env.SITE_HOST_CUSTOM || 'http://localhost:3000'
export const ORDERBOOK_PATH = window._env_.REACT_APP_ORDERBOOK_PATH || process.env.REACT_APP_ORDERBOOK_PATH || process.env.ORDERBOOK_PATH || `/wyvern/v${ORDERBOOK_VERSION}`
export const API_PATH = window._env_.REACT_APP_API_PATH || process.env.REACT_APP_API_PATH || process.env.API_PATH || `/api/v${ORDERBOOK_VERSION}`
